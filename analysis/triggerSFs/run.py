...
if __name__ == '__main__':
  ...
  parser.add_argument('--outname','-o'   , default='triggerSFs', help = 'Name of the output file with histograms')
  ...
  processor_instance = triggerSFs.AnalysisProcessor(samplesdict)
